...
- **Hardware**: System architecture, performance tuning, diagnostics, and custom builds  
- **Software**: System programming (Rust, C++), automation (Python, Bash), and infrastructure  
- **Integration**: Bridging hardware and software to create responsive, optimized solutions  

### Key Strengths

- Built automated diagnostic tools for hardware systems  
- Containerized hardware management applications using Docker and Kubernetes  
- Designed CI/CD pipelines and cloud-native infrastructure  
- Optimized system performance through tight HW-SW coupling  
...
<div>
  ...
  <img src="https://img.shields.io/badge/Now%20Playing-Again%20by%20Fullmetal%20Alchemist:%20Brotherhood-FF69B4?style=for-the-badge&logo=youtube-music&logoColor=white" alt="Again by Fullmetal Alchemist: Brotherhood"/>
